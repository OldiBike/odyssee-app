    ...
    footer_html = f"""
        ...
        <div class="instagram-card p-6 text-center">
            ...
            <div class="flex justify-center gap-4 flex-wrap">
                <a href="https://wa.me/?text=Découvrez cette superbe offre de voyage : {display_hotel_name} à partir de {your_price}€ ! " 
                   target="_blank" 
                ...
                <a href="https://www.instagram.com/" 
                   ...
                   class="flex items-center gap-2 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 hover:opacity-90 text-white font-semibold py-3 px-6 rounded-full transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                        <path d="M8 0C5.829 0 5.556.01 4.703.048 3.85.088 3.269.222 2.76.42a3.9 3.9 0 0 0-1.417.923A3.9 3.9 0 0 0 .42 2.76C.222 3.268.087 3.85.048 4.703.01 5.555 0 5.827 0 8s.01 2.444.048 3.297c.04.852.174 1.433.372 1.942.205.526.478.972.923 1.417.444.445.89.719 1.416.923.51.198 1.09.333 1.942.372C5.555 15.99 5.827 16 8 16s2.444-.01 3.297-.048c.852-.04 1.433-.174 1.942-.372.526-.205.972-.478 1.417-.923.445-.444.718-.891.923-1.417.198-.51.333-1.09.372-1.942C15.99 10.445 16 10.173 16 8s-.01-2.444-.048-3.297c-.04-.852-.174-1.433-.372-1.942a3.9 3.9 0 0 0-.923-1.417A3.9 3.9 0 0 0 13.24.42c-.51-.198-1.09-.333-1.942-.372C10.445.01 10.173 0 8 0m0 1.44c2.136 0 2.389.01 3.232.046.78.035 1.204.166 1.486.275.373.145.64.318.92.598.28.28.453.546.598.92.11.281.24.705.275 1.485.038.843.046 1.096.046 3.232s-.008 2.389-.046 3.232c-.035.78-.166 1.204-.275 1.486a2.477 2.477 0 0 1-.598.92c-.28.28-.546.453-.92.598-.28.11-.704.24-1.485.275-.843.038-1.096.046-3.232.046s-2.39-.008-3.233-.046c-.78-.035-1.204-.165-1.485-.275a2.477 2.477 0 0 1-.92-.598 2.477 2.477 0 0 1-.6-.92c-.109-.281-.24-.705-.275-1.485-.037-.843-.046-1.096-.046-3.232s.01-2.39.046-3.233c.036-.78.166-1.204.276-1.485.145-.373.319-.64.599-.92.28-.28.546-.453.92-.598.282-.11.705-.24 1.485-.276.738-.034 1.024-.044 2.515-.045v.002zm4.988 1.328a.96.96 0 1 0 0 1.92.96.96 0 0 0 0-1.92zm-4.27 1.122a4.109 4.109 0 1 0 0 8.217 4.109 4.109 0 0 0 0-8.217zm0 1.441a2.667 2.667 0 1 1 0 5.334 2.667 2.667 0 0 1 0-5.334z"/>
                    </svg>
                    Instagram
                </a>
            </div>
